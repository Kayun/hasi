...
/******/ 	var hotCurrentHash = "3270412b79d5605fa075"; // eslint-disable-line no-unused-vars
...
/******/ 	__webpack_require__.p = "/hasi/public/";
/******/
/******/ 	// __webpack_hash__
...
(0, _jquery2.default)(function () {
  ...
  var $aside = (0, _jquery2.default)('.js-aside');
  var $calculator = (0, _jquery2.default)('.js-calculator');

  var $sortContainer = (0, _jquery2.default)('.js-sort');

  var $slider = (0, _jquery2.default)('.js-slider');
  ...
  var examSwiper = new _swiper2.default('.js-slider', {
    slidesPerView: 1,
  ...
  $sortContainer.length && $sortContainer.sortable({
    stop: function stop(event, ui) {
      var $counts = (0, _jquery2.default)('.js-sort-count', $sortContainer);
      $counts.each(function (index, item) {
        return (0, _jquery2.default)(item).text(index + 1);
      });
    }
  });

  $fontSwitch.on('click', '.font-switch__option', function (event) {
    var $target = (0, _jquery2.default)(event.target);
    var size = (0, _jquery2.default)(window).width() <= 768 ? $target.data('mobileSize') : $target.data('size');
  ...
  $aside.on('click', '.js-calc-mode', function (event) {
    var $target = (0, _jquery2.default)(event.target);
    ...
    if ($target.hasClass('_active')) {
      ...
      calcInstance = new _calculator.Calculator($calculator.get(0));
    } else {
...
var Calculator = exports.Calculator = function () {
  function Calculator(element) {
    ...
    this.keyboard = (0, _jquery2.default)('.js-calculator-keyboard', element);
    this.capacity = 10;
    ...
    this.destroy = function () {
      _this.keyboard.off('click', onClick);
      _this.clear();
    };
  }
